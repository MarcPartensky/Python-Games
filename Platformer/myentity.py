...
class Entity:
    made=0
    def __init__(self,name="Unnamed",id=None,position=None,size=None,velocity=[0,0],acceleration=[0,0],borders=None,direction=[0,0],friction=0,dimensions=2,moving_function=lambda x:50*x,controllable=False):

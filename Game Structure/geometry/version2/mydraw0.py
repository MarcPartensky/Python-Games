...
class Draw:
    ...
    def line(self,color,start_position,end_position,width=1):
        ...
        self.window.draw.line(self.window.screen,color,start_position,end_position,width)

    def lines(self,color,positions,connected=True,width=1):
        new_positions=self.plane.getAllToScreen(positions,self.window)
        self.window.draw.lines(self.window.screen,color,connected,positions,width)

from myabstract import Point, Segment, Form, Vector
import mycolors
import random
import math
...
class Graph:
    ...
    def __init__(self, points, connections, point_color=mycolors.RED,
            segment_color=mycolors.BLUE, vector_color=mycolors.GREEN):

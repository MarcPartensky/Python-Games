...
class Graph(Function):
    ...
    def __init__(self,function,name=None,color=mycolors.WHITE):
...
class Grapher(SimpleManager):
    ...
    def setColors(self):
        ...
        self.colors=[mycolors.RED,mycolors.BLUE,mycolors.GREEN,mycolors.YELLOW,mycolors.PURPLE,mycolors.ORANGE,mycolors.BROWN]
        self.colors+=[mycolors.random() for i in range(len(self.functions)-len(self.colors))][:len(self.functions)]
